...
public class TestMyListViewActivity extends AppCompatActivity {

    TestMyListViewActivityBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        binding = TestMyListViewActivityBinding.inflate(getLayoutInflater());
        ...
        try {
            binding.myListView.setItemDataList(itemDataList);
        }
